...
if __name__ == '__main__':
    ...
    parser.add_argument('--oppo1', type=str, choices={'ac', 'mfac', 'mfq', 'il', 'mtmfq'}, help='indicate the opponent model')
    parser.add_argument('--oppo2', type=str, choices={'ac', 'mfac', 'mfq', 'il', 'mtmfq'}, help='indicate the opponent model')
    parser.add_argument('--oppo3', type=str, choices={'ac', 'mfac', 'mfq', 'il', 'mtmfq'}, help='indicate the opponent model')
