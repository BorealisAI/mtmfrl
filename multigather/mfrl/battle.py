...
if __name__ == '__main__':
    ...
    models = [spawn_ai(args.algo, sess, env, player_handles[0], args.algo + '-me', args.max_steps), spawn_ai(args.oppo1, sess, env, player_handles[1], args.oppo1 + '-opponent1', args.max_steps), spawn_ai(args.oppo2, sess, env, player_handles[2], args.oppo2 + '-opponent2', args.max_steps), spawn_ai(args.oppo3, sess, env, player_handles[3], args.oppo3 + '-opponent3', args.max_steps)]
